 ...
 */
final class Version20200626122856 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, user_id INT NOT NULL, date DATE NOT NULL, title VARCHAR(70) NOT NULL, INDEX IDX_5387574A12469DE2 (category_id), INDEX IDX_5387574AA76ED395 (user_id), UNIQUE INDEX title_user_idx (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
